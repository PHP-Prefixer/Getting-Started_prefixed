...
use PPP\Monolog\Formatter\LineFormatter;
...
class AbstractHandlerTest extends TestCase
{
    ...
    {
        $handler = $this->getMockForAbstractClass('PPP\Monolog\Handler\AbstractHandler', array(Logger::WARNING, false));
    ...
    {
        $handler = $this->getMockForAbstractClass('PPP\Monolog\Handler\AbstractHandler');
    ...
    {
        $handler = $this->getMockForAbstractClass('PPP\Monolog\Handler\AbstractHandler');
        $this->assertInstanceOf('PPP\Monolog\Formatter\LineFormatter', $handler->getFormatter());
    }
    ...
    {
        $logger = $this->getMockForAbstractClass('PPP\Monolog\Handler\AbstractHandler');
