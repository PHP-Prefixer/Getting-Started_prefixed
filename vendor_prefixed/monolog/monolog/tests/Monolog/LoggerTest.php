...
class LoggerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLog()
    {
        ...
        $handler = $this->getMock('PPP\Monolog\Handler\NullHandler', array('handle'));
    ...
    public function testLogNotHandled()
    {
        ...
        $handler = $this->getMock('PPP\Monolog\Handler\NullHandler', array('handle'), array(Logger::ERROR));
    ...
    {
        $logger = new Logger(__METHOD__);
        $handler = $this->getMock('PPP\Monolog\Handler\HandlerInterface');
        ...
        $processor = $this->getMockBuilder('PPP\Monolog\Processor\WebProcessor')
    ...
    public function testHandlersNotCalledBeforeFirstHandling()
    {
        ...
        $handler1 = $this->getMock('PPP\Monolog\Handler\HandlerInterface');
        ...
        $handler2 = $this->getMock('PPP\Monolog\Handler\HandlerInterface');
        ...
        $handler3 = $this->getMock('PPP\Monolog\Handler\HandlerInterface');
