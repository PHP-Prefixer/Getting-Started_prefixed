...
namespace PPP\Monolog\Formatter;
...
class LineFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDefFormatWithObject()
    {
        ...
        $this->assertEquals('['.date('Y-m-d').'] meh.ERROR: foobar [] {"foo":"[object] (PPP\\Monolog\\Formatter\\TestFoo: {"foo":"foo"})","bar":"[object] (PPP\\Monolog\\Formatter\\TestBar: {})","baz":[],"res":"[resource]"}'."\n", $message);
    }
